...
|---|---|---|---|
| TICKET-001 | CSS Zwei-Spalten-Layout + Toggle-Button in SlideView | — | DONE |
| TICKET-002 | localStorage-Persistenz des Column-Toggle-Zustands | TICKET-001 | DONE |
...
- [x] TICKET-001 DONE
- [x] TICKET-002 DONE
- [x] `npm test` grün — 198 Tests
- [x] `npx tsc --noEmit` sauber
- [x] Browser-Verifikation: langer Song fließt zweispaltig; Toggle bleibt beim Blättern erhalten; nach Reload ist der Zustand wiederhergestellt
