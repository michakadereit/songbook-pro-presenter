...
|---|---|---|---|
| TICKET-001 | Global Controls DOM + CSS im ViewSwitcher | — | DONE |
| TICKET-002 | EagleView: interne Controls entfernen, externes State-API | TICKET-001 | DONE |
| TICKET-003 | SlideView: Suche entfernen, Transpose-Support + externes State-API | TICKET-001 | DONE |
| TICKET-004 | ViewSwitcher: globale Controls mit Views verdrahten | TICKET-002, TICKET-003 | DONE |
...
- [x] TICKET-003 DONE
- [x] TICKET-004 DONE
- [x] `npm test` grün — 188 Tests
- [x] `npx tsc --noEmit` sauber
- [x] Browser-Verifikation: Suche und Transpose bleiben beim View-Wechsel erhalten
- [x] Merge nach `main`, Branch gelöscht (2026-06-26)
